...
class TestLlama3_1_8B(LlmapiAccuracyTestHarness):
    ...
    MODEL_PATH = _hf_model_dir_or_hub_id("llama-3.1-model/Meta-Llama-3.1-8B", MODEL_NAME)
    ...
    def get_default_sampling_params(self):
        ...
        return SamplingParams(
            end_id=eos_id, pad_id=eos_id, n=beam_width, use_beam_search=beam_width > 1
        )
    ...
    def test_auto_dtype(self):
        ...
        with AutoDeployLLM(model=self.MODEL_PATH, tokenizer=self.MODEL_PATH, **kwargs) as llm:
