...
def test_eagle_model_with_weights():
    ...
    # - t2d: target-to-draft mapping, not used in Eagle3 (uses d2t instead). The draft is rooted at
    #   the "eagle_drafter" namespace, so the checkpoint's "t2d" maps to "eagle_drafter.t2d".
