...
class InferenceOptimizer:
    ...
    def __call__(self, cm: CachedSequenceInterface) -> nn.Module:
        ...
        # self.ad_config.simple_shard_only = True
        self.ad_config.use_sharding_from_factory = True
        ...
        ad_logger.info("TP sharding_config:\n")
        for t in sharding_config.tp_transforms:
            ad_logger.info(f"{t}")
        ad_logger.info("\n\n")
