...
class SequenceInfo:
    ...
    def __post_init__(self):
        ...
        self._num_pages = max(self.max_batch_size, (total_tokens) // self.page_size + (total_tokens % self.page_size > 0))
        ...
        assert self.num_pages >= self.max_batch_size, "num_pages must be greater than max_batch_size"
