...
def _fused_topk_softmax_kernel(
    ...
    TOP_K: tl.constexpr,  # number of top experts to select
):
    ...
    # We maintain two arrays of size TOP_K for the results.
    topk_vals = tl.full([TOP_K], float("-inf"), dtype=tl.float32)
