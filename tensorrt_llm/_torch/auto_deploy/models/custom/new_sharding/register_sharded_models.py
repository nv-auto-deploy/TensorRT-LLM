...
_IMPORT_LINES = [
    f"import tensorrt_llm._torch.auto_deploy.models.custom.new_sharding.modeling_llama3  {_MARKER}",
    f"import tensorrt_llm._torch.auto_deploy.models.custom.new_sharding.modeling_mistral  {_MARKER}",
    f"import tensorrt_llm._torch.auto_deploy.models.custom.new_sharding.modeling_internlm3  {_MARKER}",
    f"import tensorrt_llm._torch.auto_deploy.models.custom.new_sharding.modeling_qwen3  {_MARKER}",
    f"import tensorrt_llm._torch.auto_deploy.models.custom.new_sharding.modeling_smollm3  {_MARKER}",
    f"import tensorrt_llm._torch.auto_deploy.models.custom.new_sharding.modeling_deepseek  {_MARKER}",
    f"import tensorrt_llm._torch.auto_deploy.models.custom.new_sharding.modeling_deepseek_v2  {_MARKER}",
