...
For default values and additional configuration options, refer to the [`ExperimentConfig`](./build_and_run_ad.py#L92) class in [build_and_run_ad.py](./build_and_run_ad.py) file.
...
[`AutoDeployConfig` class](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L42)
for more detail on how AutoDeploy is configured via the `**kwargs` of the `LLM` API.

### Expert Configuration of LLM API

For expert TensorRT-LLM users, we also expose the full set of [`LlmArgs`](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L222)
...
- For expert users we expose the full set of [`LlmArgs`](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L222)
...
- Note that some fields in the full [`LlmArgs`](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L222)
...
- However, with the proper care the full [`LlmArgs`](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L222)
...
The script supports flexible CLI argument parsing using dot notation to modify nested configurations dynamically. You can target any field in both the [`ExperimentConfig`](./build_and_run_ad.py#L92) and nested [`AutoDeployConfig`](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L41)/[`LlmArgs`](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L221) objects:
...
Both [`ExperimentConfig`](./build_and_run_ad.py#L92) and [`AutoDeployConfig`](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L41)/[`LlmArgs`](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L221) inherit from [`DynamicYamlMixInForSettings`](../../tensorrt_llm/_torch/auto_deploy/utils/_config.py#L57), enabling you to provide multiple YAML configuration files that are automatically deep-merged at runtime.
...
Both [`AutoDeployConfig`](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L41) and [`LlmArgs`](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L221) classes automatically load a built-in [`default.yaml`](../../tensorrt_llm/_torch/auto_deploy/config/default.yaml) configuration file that provides sensible defaults for the AutoDeploy inference optimizer pipeline. This file is specified in the [`_get_config_dict()`](../../tensorrt_llm/_torch/auto_deploy/llm_args.py#L19) function and defines default transform configurations for graph optimization stages.
